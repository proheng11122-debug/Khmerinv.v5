...
export default function App() {
  ...
  if (screen === 'welcome') {
    return <Welcome onBack={() => setScreen('landing')} />
  }
    ...
    <div className="page">
      ...
      <section className="bottom">
        ...
        <div className="auth-row">
          <button className="auth-btn primary khmer" onClick={() => setScreen('welcome')}>
            ចូលគណនី (Sign In)
          </button>
          <button className="auth-btn outline khmer" onClick={() => setScreen('welcome')}>
            បង្កើតគណនី (Sign Up)
          </button>
        </div>
